...
/**
 * Worker that prints time and number of letters given in "name" parameter.
 * If no name parameter is given, it will print appropriate message.
 * @author Hrvoje Matic
 */
public class HelloWorker implements IWebWorker {
	...
	public void processRequest(RequestContext context) {
		...
		try {
			...
			Logger.getLogger().log("IOException in HelloWorker.", ex);
		}
	}
}
