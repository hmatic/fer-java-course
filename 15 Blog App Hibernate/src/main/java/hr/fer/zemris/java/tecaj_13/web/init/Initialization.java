...
/**
 * Listener triggered when application is started. It initializes entity manager
 * factory and puts it inside JPAEMFProvider.
 * Closes entity manager factory when application exits.
 * @author Hrvoje Matic
 * @version 1.0
 */
@WebListener
